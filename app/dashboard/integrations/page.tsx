    ...
    <main className="p-6">
      ...
      <div className="mx-auto max-w-5xl">
        ...
        {facebookAccountsError ? (
          <div className="mb-4 rounded-xl border border-red-200 bg-red-50 px-4 py-3 text-sm text-red-700">
            Unable to load Facebook connections:{" "}
        ...
        <section className="overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm">
          <div className="flex flex-col justify-between gap-4 border-b border-slate-200 p-6 sm:flex-row sm:items-center">
            ...
            <div className="flex flex-wrap gap-2">
              <Link
                href="/api/facebook/access-audit"
                target="_blank"
              ...
              <Link
                href="/api/facebook/subscription-status"
                target="_blank"
                className="rounded-xl border border-slate-300 bg-white px-4 py-2.5 text-sm font-semibold text-slate-700 transition hover:bg-slate-50"
              >
                Webhook status
            ...
            <div className="divide-y divide-slate-200">
              {connectedPages.map(
                (account) => {
                  ...
                  const tokenStatus =
                    account.facebook_token_status?.trim() ||
                    "stored";
                  ...
                  return (
                    ...
                    >
                      <div className="flex flex-col justify-between gap-5 lg:flex-row lg:items-center">
                        ...
                        <div className="flex flex-wrap gap-2">
                          <Link
                            href={`/dashboard/inbox?page=${encodeURIComponent(
                              account.id,
                            )}`}
                            className="inline-flex items-center justify-center rounded-xl bg-blue-600 px-4 py-2.5 text-sm font-semibold text-white transition hover:bg-blue-700"
                          >
