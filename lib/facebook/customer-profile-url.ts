...
export function normalizeFacebookProfileUrl(value: unknown): string | null {
  ...
  try {
    ...
    if (["business", "latest", "messages", "login", "logout", "checkpoint", "settings", "help", "groups", "pages", "watch", "reels", "marketplace", "search", "friends", "bookmarks", "gaming", "ads", "privacy", "notifications", "home", "photo", "photos", "posts", "videos", "share", "story"].includes(username.toLowerCase())) return null;
