const messages: Record<string, string> = {
  profile_conversation_link_unavailable: "Meta did not provide a verifiable link to this customer's conversation. TENH cannot yet discover this public profile automatically.",
  ...
  profile_navigation_moved_to_website: "Update TENH Companion to version 1.2.23 or later, then refresh TENH and Facebook.",
