const messages: Record<string, string> = {
  ...
  facebook_no_contact_card: "Facebook did not expose a public profile for this customer yet.",
  facebook_inbox_load_failed: "Facebook could not load enough customer information to verify a public profile.",
  ...
  facebook_tab_in_use: "TENH will check Facebook automatically. Retry in a moment.",
  ...
  profile_customer_heading_missing: "Facebook did not expose a verified public profile for this customer yet.",
  ...
  facebook_bridge_unavailable: "TENH Companion could not verify a matching public Facebook profile for this customer.",
